defmodule JumpExerciseWeb.ChatLive do
  use Elixir.JumpExerciseWeb, :live_view
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      ...
      |> stream(
        :conversations,
        JumpExercise.Chat.my_conversations!(actor: socket.assigns.current_user)
      )
      |> assign(:messages, [])
  ...
  defp assign_message_form(socket) do
    form =
      if socket.assigns.conversation do
        JumpExercise.Chat.form_to_create_message(
          actor: socket.assigns.current_user,
          private_arguments: %{conversation_id: socket.assigns.conversation.id}
        )
        |> to_form()
      else
        JumpExercise.Chat.form_to_create_message(actor: socket.assigns.current_user)
        |> to_form()
      end
